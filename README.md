...
**Diseño principal del menu**
    ...
    INICIO 
        ...
        **MIENTRAS** opcion != 6 HACER
            ...
            Imprimir "5. Buscar curso por nombre (búsqueda lieal)"
            ...
            Imprimir "10. Buscar curso por nombre (búsque binaria)"
            ...
            **Si** opcion = 1 enntonces
            ...
            SiNo 
                ...
                **Actualizar nota**
            SiNo 
                Si opcion = 7 enntonces
                **Eliminar curso**
            SiNo 
                Si opcion = 8 enntonces
                **Ordenar curso por nota**
            SiNo 
                Si opcion = 9 enntonces
                **Ordenar curso por nobre**
            SiNo 
                Si opcion = 10 enntonces
                **eliminar_curso**
            SiNo 
                Si opcion = 11 enntonces
                **Buscar curso**
            SiNo
                Si opcion = 12 enntonces
                **Hitorial**
            SiNo 
                Si opcion = 13 enntonces
